  ...
  return (
    <>
      <div className="relative h-[100vh] w-full flex items-center justify-center">
                ...
                <div className="flex flex-col">
                  <form>
                    <div className="flex bg-black p-1 pl-2 rounded-xl justify-between">
                      ...
                      <button
                        type="submit"
                        className="text-center text-sm leading-7 justify-between pt-2 ml-2 apply_now rounded-xl z-10 py-2 px-4 disabled:opacity-80 disabled:cursor-not-allowed"
                      >
                        <span>Apply Now</span>
                      </button>
                    </div>
        ...
        <video autoPlay muted loop playsInline className="animation_video">
          <source
